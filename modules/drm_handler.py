...
#........................................................................................................................................................................................
            try:
                if m.text:
                    ...
                    if topic == "/yes":
                        if caption == "/cc1":
                            cc = f"<b>Index:</b> <code>{str(count).zfill(3)}</code>\n\n"f"<b>Title:</b> <code>{v_name} [{res}p].mkv</code>\n\n"f"<b>Batch:</b> <blockquote><b>{b_name}</b>\n"f"<b>Topic: {t_name}</b></blockquote>\n\n"f"<b>Extracted By:</b> {CR}"
                            cc1 = f"<b>Index:</b> <code>{str(count).zfill(3)}</code>\n\n"f"<b>Title:</b> <code>{v_name}.pdf</code>\n\n"f"<b>Batch:</b> <blockquote><b>{b_name}</b>\n"f"<b>Topic: {t_name}</b></blockquote>\n\n"f"<b>Extracted By:</b> {CR}"
                            cczip = f"<b>Index:</b> <code>{str(count).zfill(3)}</code>\n\n" f"<b>Title:</b> <code>{v_name}.zip</code>\n\n"f"<b>Batch:</b> <blockquote><b>{b_name}</b>\n"f"<b>Topic: {t_name}</b></blockquote>\n\n"f"<b>Extracted By:</b> {CR}"
                            ccimg = f"<b>Index:</b> <code>{str(count).zfill(3)}</code>\n\n"f"<b>Title:</b> <code>{v_name}.jpg</code>\n\n"f"<b>Batch:</b> <blockquote><b>{b_name}</b>\n"f"<b>Topic: {t_name}</b></blockquote>\n\n"f"<b>Extracted By:</b> {CR}"
                            cchtml = f"<b>Index:</b> <code>{str(count).zfill(3)}</code>\n\n"f"<b>Title:</b> <code>{v_name}.html</code>\n\n"f"<b>Batch:</b> <blockquote><b>{b_name}</b>\n"f"<b>Topic: {t_name}</b></blockquote>\n\n"f"<b>Extracted By:</b> {CR}"
                            ccyt = f"<b>Index:</b> <code>{str(count).zfill(3)}</code>\n\n"f"<b>Title:</b> <code>{v_name}.mp4</code>\n\n"f"<b>Stream:</b> <a href='{url}'><b>Click Here to Watch</b></a>\n\n"f"<b>Batch:</b> <blockquote><b>{b_name}</b>\n"f"<b>Topic: {t_name}</b></blockquote>\n\n"f"<b>Extracted By:</b> {CR}"
                            ccm = f"<b>Index:</b> <code>{str(count).zfill(3)}</code>\n\n"f"<b>Title:</b> <code>{v_name}.mp3</code>\n\n"f"<b>Batch:</b> <blockquote><b>{b_name}</b>\n"f"<b>Topic: {t_name}</b></blockquote>\n\n"f"<b>Extracted By:</b> {CR}"   
                        elif caption == "/cc2":
